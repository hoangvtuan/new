...
<body>
  ...
  <header>
    ...
    <div class="content pt-5 pb-3">
      <?php 
        //edit
        require('controller/c_work.php');//gọi đên c_work.php
          $c_work = new C_work();
          $c_work->editWork();
       ?>
      <form class="container pt-5 pb-5" method="post" action="edit.php">
        <div class="form-group row">
          <label for="input" class="col-sm-2 col-form-label">ID</label>
          <div class="col-sm-10">
            <input type="number" class="form-control" id="input" name="Id" placeholder="ID">
          </div>
        </div>
        <div class="form-group row">
